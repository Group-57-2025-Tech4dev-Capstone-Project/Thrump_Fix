  ...
  return (
    <div className="px-5 py-10 flex flex-col items-center gap-5">
      ...
      <div className="flex items-center gap-3 w-full bg-gray-50 rounded-2xl px-4 py-3">
        ...
        {/* Phone button — only if phone is available */}
        {plumber?.phone && (
          <a
            href={`tel:${plumber.phone}`}
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-xs font-bold px-4 py-2 rounded-full transition"
          >
