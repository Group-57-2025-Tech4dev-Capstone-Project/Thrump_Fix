...
export default function CTA() {
  ...
  const goToSignupAsCustomer = () => {
    navigate(route.Signup, { state: { defaultRole: "CUSTOMER" } });
  };

  const goToSignupAsPlumber = () => {
    navigate(route.Signup, { state: { defaultRole: "PLUMBER" } });
  };
