...
////            throw new BadRequestException("You must accept Privacy & Policy");
////        }
//        if (request.getAcceptedPrivacyPolicy() == null ||
//                !Boolean.parseBoolean(request.getAcceptedPrivacyPolicy())) {
//            throw new BadRequestException("You must accept Privacy & Policy");
//        }
//
//        // ✅ 4. ROLE SELECTION
...
//                .verificationStatus(VerificationStatus.PENDING)
//                .nationalIdFile(storedFile)
//                .acceptedPrivacyAndPolicy(request.getAcceptedPrivacyPolicy())
//                .acceptedPrivacyAndPolicyAt(LocalDateTime.now())
//                .onlineStatus(OnlineStatus.OFFLINE)
//                .enabled(true)
//                .build();
